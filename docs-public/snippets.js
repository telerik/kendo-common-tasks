...
<head>\
    ...
    <style>\
        ...
        my-app > .k-icon.k-i-loading, .loading-animation .k-icon.k-i-loading { font-size: 64px; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); }\
        ...
        .loading-animation:not([v-cloak]) {display: none }\
    </style>\
...
<body>\
    ...
    # } else { #\
    <div id="vueapp">\
        <div class="loading-animation" v-cloak>\
            <span class="k-icon k-i-loading" style="color: #: data.themeAccent || "\\#ff6358" #"></span>\
        </div>\
        #= data.html #\
    </div>\
