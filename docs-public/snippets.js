...
var stackBlitzDependencies = {
    'angular': function(production) {
        const chanel = production ? "latest" : "dev";
        return {
            'core-js': '2.5.3',
            'rxjs': '5.5.6',
            'zone.js': '0.8.12',
            ...
            '@angular/forms': '5.2.2',
            'hammerjs': '*',
            '@telerik/kendo-intl': chanel,
            '@progress/kendo-date-math': chanel,
            '@progress/kendo-drawing': chanel,
            '@progress/kendo-data-query': chanel,
            '@progress/kendo-file-saver': chanel,
            '@progress/kendo-charts': chanel,
            '@progress/kendo-angular-buttons': chanel,
            '@progress/kendo-angular-charts': chanel,
            '@progress/kendo-angular-dateinputs': chanel,
            '@progress/kendo-angular-dialog': chanel,
            '@progress/kendo-angular-dropdowns': chanel,
            '@progress/kendo-angular-excel-export': chanel,
            '@progress/kendo-angular-gauges': chanel,
            '@progress/kendo-angular-grid': chanel,
            '@progress/kendo-angular-inputs': chanel,
            '@progress/kendo-angular-intl': chanel,
            '@progress/kendo-angular-l10n': chanel,
            '@progress/kendo-angular-label': chanel,
            '@progress/kendo-angular-layout': chanel,
            '@progress/kendo-angular-menu': chanel,
            '@progress/kendo-angular-pdf-export': chanel,
            '@progress/kendo-angular-popup': chanel,
            '@progress/kendo-angular-resize-sensor': chanel,
            '@progress/kendo-angular-ripple': chanel,
            '@progress/kendo-angular-scrollview': chanel,
            '@progress/kendo-angular-sortable': chanel,
            '@progress/kendo-angular-tooltip': chanel,
            '@progress/kendo-angular-treeview': chanel,
            '@progress/kendo-angular-upload': chanel
        };
    },
    'builder': function() {
        return {
    ...
    'vue': function(production) {
        const chanel = production ? "latest" : "dev";
        return {
            "@progress/kendo-barcodes-vue-wrapper": chanel,
            "@progress/kendo-buttons-vue-wrapper": chanel,
            "@progress/kendo-charts-vue-wrapper": chanel,
            "@progress/kendo-chat-vue-wrapper": chanel,
            "@progress/kendo-datasource-vue-wrapper": chanel,
            "@progress/kendo-dateinputs-vue-wrapper": chanel,
            "@progress/kendo-diagram-vue-wrapper": chanel,
            "@progress/kendo-dialog-vue-wrapper": chanel,
            "@progress/kendo-dropdowns-vue-wrapper": chanel,
            "@progress/kendo-dropdowntree-vue-wrapper": chanel,
            "@progress/kendo-gantt-vue-wrapper": chanel,
            "@progress/kendo-gauges-vue-wrapper": chanel,
            "@progress/kendo-grid-vue-wrapper": chanel,
            "@progress/kendo-editor-vue-wrapper": chanel,
            "@progress/kendo-inputs-vue-wrapper": chanel,
            "@progress/kendo-layout-vue-wrapper": chanel,
            "@progress/kendo-listbox-vue-wrapper": chanel,
            "@progress/kendo-listview-vue-wrapper": chanel,
            "@progress/kendo-map-vue-wrapper": chanel,
            "@progress/kendo-mediaplayer-vue-wrapper": chanel,
            "@progress/kendo-pivotgrid-vue-wrapper": chanel,
            "@progress/kendo-popups-vue-wrapper": chanel,
            "@progress/kendo-scheduler-vue-wrapper": chanel,
            "@progress/kendo-spreadsheet-vue-wrapper": chanel,
            "@progress/kendo-treelist-vue-wrapper": chanel,
            "@progress/kendo-treemap-vue-wrapper": chanel,
            "@progress/kendo-treeview-vue-wrapper": chanel,
            "@progress/kendo-upload-vue-wrapper": chanel,
            "@progress/kendo-validator-vue-wrapper": chanel,
            "@progress/kendo-window-vue-wrapper": chanel,
            "@progress/kendo-ui": "*",
            "jquery": "*",
            "vue": "*",
            "@progress/kendo-base-components-vue-wrapper": chanel,
            "@progress/kendo-theme-bootstrap": "^2.11.11",
            "@progress/kendo-theme-default": "^2.50.0",
            "@progress/kendo-theme-material": "^0.3.0"
        };
    ...
    'react': function(production) {
        ...
        return {
            ...
            "@progress/kendo-drawing": chanel,
            "@progress/kendo-file-saver": chanel,
            "@progress/kendo-react-animation": chanel,
            "@progress/kendo-react-buttons": chanel,
            "@progress/kendo-react-charts": chanel,
            "@progress/kendo-react-conversational-ui": chanel,
            "@progress/kendo-react-dateinputs": chanel,
            "@progress/kendo-react-dialogs": chanel,
            "@progress/kendo-react-dropdowns": chanel,
            "@progress/kendo-react-excel-export": chanel,
            "@progress/kendo-react-grid": chanel,
            "@progress/kendo-react-inputs": chanel,
            "@progress/kendo-react-intl": chanel,
            "@progress/kendo-react-layout": chanel,
            "@progress/kendo-react-pdf": chanel,
            "@progress/kendo-react-popup": chanel,
            "@progress/kendo-react-ripple": chanel,
            "@progress/kendo-theme-bootstrap": chanel,
            "@progress/kendo-theme-default": chanel,
            "@progress/kendo-theme-material": chanel,
            "cldr-data": "^32.0.1",
            "hammerjs": "~2.0.8",
            "object-assign": "^4.0.1",
            "prop-types": "^15.6.0",
